...
\definecolor{ly}{RGB}{255,255,230}
\pagecolor{ly}
...
\title{Multiparty State Channels\\ Enabling real-time Poker on Ethereum}
...
% affiliations
\author{
 \IEEEauthorblockN{Alex Lunyov}
 \IEEEauthorblockA{isuntc@gmail.com}
\and
\IEEEauthorblockN{Johann Barbie}
\IEEEauthorblockA{johannbarbie@me.com}
\and
\IEEEauthorblockN{Konstantin Korenkov}
\IEEEauthorblockA{7r0ggy@gmail.com}
\and
\IEEEauthorblockN{Mayank Kumar}
\IEEEauthorblockA{workwithmayank@gmail.com}
...
\onecolumn
\appendices
\section{Table Contract Source Code}
\begin{verbatim}
