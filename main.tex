...
\title{Acebusters\\ A real-time Poker Application on the Ethereum Blockchain}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Helge Wieding}
\IEEEauthorblockA{Email: helge@acebusters.com}
\and
\IEEEauthorblockN{Johann Barbie}
\IEEEauthorblockA{Email: johann@acebusters.com}}
% \and
